        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            ...
            <div class="glass-card shadow-lg p-4">
              ...
              <p class="text-secondary small mb-4">Enter the token sent to your email and your new password.</p>
              
              <form (submit)="onSubmit($event)">
                <div class="mb-3">
                  <label class="form-label small fw-medium">Reset Token</label>
                  <div class="input-group border rounded-3 p-1">
                    <span class="input-group-text border-0 bg-transparent text-muted"><span class="material-icons">key</span></span>
                    <input type="text" [(ngModel)]="token" name="token" class="form-control border-0 shadow-none bg-transparent" placeholder="Paste token here" required />
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group border rounded-3 p-1">
                    ...
                    <input type="password" [(ngModel)]="newPassword" name="newPassword" class="form-control border-0 shadow-none bg-transparent" placeholder="••••••••" required />
                  </div>
                </div>
                ...
                <div class="mb-4">
                  ...
                  <div class="input-group border rounded-3 p-1">
                    <span class="input-group-text border-0 bg-transparent text-muted"><span class="material-icons">lock</span></span>
                    <input type="password" [(ngModel)]="confirmPassword" name="confirmPassword" class="form-control border-0 shadow-none bg-transparent" placeholder="••••••••" required />
                  </div>
                </div>
  ...
  onSubmit(event: Event): void {
    ...
    this.auth.resetPassword({ token: this.token, newPassword: this.newPassword }).subscribe({
      next: (res: any) => {
        ...
        this.toast.showSuccess(res.Message || 'Password reset successfully.');
